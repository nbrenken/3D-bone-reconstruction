...
class FeatureExtractor(torch.nn.Module):
    def __init__(self, checkpoint_file: Path, DAX_model_type = "resnet50", device=None):
        super().__init__()
