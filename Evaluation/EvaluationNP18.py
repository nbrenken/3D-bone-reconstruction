...
from ThirdModelOWN18Training import (
    SpineDataset,
    SpineDataloader,
...
def main():
    ...
    model_checkpoint = Path(
        r"C:\Users\karlo\OneDrive\Desktop\DinoVert\ShirleySTUFF\models_ownresnet18\best_model.pth"
    )

    output_csv = Path(
        r"C:\Users\karlo\OneDrive\Desktop\DinoVert\ShirleySTUFF\EVALNP18\test_segmentation_metrics_resultsOWNRES.csv"
    )
